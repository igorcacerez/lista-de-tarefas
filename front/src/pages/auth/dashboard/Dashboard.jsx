                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="d-flex flex-column h-100">
                                        ...
                                        <p className="mb-5">From colors, cards, typography to complex elements, you will
                    ...
                    <div className="card h-100 p-3">
                        <div className="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                            ...
                            <div className="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                                ...
                                <p className="text-white">Wealth creation is an evolutionarily recent positive-sum game.
                ...
                <div className="col-lg-5 mb-lg-0 mb-4">
                    <div className="card z-index-2">
                        <div className="card-body p-3">
                            ...
                            <p className="text-sm ms-2"> (<span className="font-weight-bolder">+23%</span>) than last
                                week </p>
                                ...
                                <div className="row">
                                    <div className="col-3 py-3 ps-0">
                                        ...
                                        <div className="progress w-75">
                                            <div className="progress-bar bg-dark w-60" role="progressbar"
                                    ...
                                    <div className="col-3 py-3 ps-0">
                                        ...
                                        <div className="progress w-75">
                                            <div className="progress-bar bg-dark w-90" role="progressbar"
                                    ...
                                    <div className="col-3 py-3 ps-0">
                                        ...
                                        <div className="progress w-75">
                                            <div className="progress-bar bg-dark w-30" role="progressbar"
                                    ...
                                    <div className="col-3 py-3 ps-0">
                                        ...
                                        <div className="progress w-75">
                                            <div className="progress-bar bg-dark w-50" role="progressbar"
